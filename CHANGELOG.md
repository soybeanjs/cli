...
- **changelog**:
  - add check for existing CHANGELOG.md and add it to git if missing &nbsp;-&nbsp; by **Soybean** [<samp>(34d86)</samp>](https://github.com/soybeanjs/cli/commit/34d8659)
  - correct command to add CHANGELOG.md &nbsp;-&nbsp; by **Soybean** [<samp>(a7b49)</samp>](https://github.com/soybeanjs/cli/commit/a7b49ac)
