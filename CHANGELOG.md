...
- **changelog**:
  - add check for existing CHANGELOG.md and add it to git if missing &nbsp;-&nbsp; by @soybeanjs [<samp>(34d86)</samp>](https://github.com/soybeanjs/cli/commit/34d8659)
  - correct command to add CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(a7b49)</samp>](https://github.com/soybeanjs/cli/commit/a7b49ac)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **projects**: remove create-soybean to standalone repository &nbsp;-&nbsp; by @soybeanjs [<samp>(bca1e)</samp>](https://github.com/soybeanjs/cli/commit/bca1e26)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**:
  - update deps and update config &nbsp;-&nbsp; by @soybeanjs [<samp>(a2bf7)</samp>](https://github.com/soybeanjs/cli/commit/a2bf7ef)
- **release**:
  - update actions and pnpm versions in release workflow &nbsp;-&nbsp; by @soybeanjs [<samp>(b0448)</samp>](https://github.com/soybeanjs/cli/commit/b0448d7)
- **vscode**:
  - remove unused extensions from recommendations &nbsp;-&nbsp; by @soybeanjs [<samp>(315c1)</samp>](https://github.com/soybeanjs/cli/commit/315c104)
  - update recommended extensions and remove unused ones &nbsp;-&nbsp; by @soybeanjs [<samp>(19d9e)</samp>](https://github.com/soybeanjs/cli/commit/19d9e9b)
...
- **changelog**: correct command to add CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(a7b49)</samp>](https://github.com/soybeanjs/cli/commit/a7b49ac)
...
- **changelog**: add check for existing CHANGELOG.md and add it to git if missing &nbsp;-&nbsp; by @soybeanjs [<samp>(34d86)</samp>](https://github.com/soybeanjs/cli/commit/34d8659)
...
- **command**: update command to use 'npm-check-updates' instead of 'ncu' &nbsp;-&nbsp; by @soybeanjs [<samp>(9efe9)</samp>](https://github.com/soybeanjs/cli/commit/9efe922)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(304db)</samp>](https://github.com/soybeanjs/cli/commit/304db33)
...
- **projects**:
  - update deps & update template &nbsp;-&nbsp; by @soybeanjs [<samp>(304af)</samp>](https://github.com/soybeanjs/cli/commit/304af72)
  - update script &nbsp;-&nbsp; by @soybeanjs [<samp>(d5856)</samp>](https://github.com/soybeanjs/cli/commit/d585611)
...
- **projects**: add new commit type `optimize` and commit scope `packages` &nbsp;-&nbsp; by @soybeanjs [<samp>(cb1f7)</samp>](https://github.com/soybeanjs/cli/commit/cb1f7cd)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(4cdda)</samp>](https://github.com/soybeanjs/cli/commit/4cdda8b)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(221f4)</samp>](https://github.com/soybeanjs/cli/commit/221f4d1)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(be6fc)</samp>](https://github.com/soybeanjs/cli/commit/be6fc67)
- **projects**: update @soybeanjs/changelog & update CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(dd33c)</samp>](https://github.com/soybeanjs/cli/commit/dd33c30)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(94a9f)</samp>](https://github.com/soybeanjs/cli/commit/94a9f9e)
- **projects**: update vscode config &nbsp;-&nbsp; by @soybeanjs [<samp>(47835)</samp>](https://github.com/soybeanjs/cli/commit/478355a)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(80433)</samp>](https://github.com/soybeanjs/cli/commit/80433b1)
...
- **projects**: update deps: changelog & fix generate changelog &nbsp;-&nbsp; by @soybeanjs [<samp>(8bf19)</samp>](https://github.com/soybeanjs/cli/commit/8bf1976)
...
- **projects**: add command "update-pkg" &nbsp;-&nbsp; by @soybeanjs [<samp>(f6ba2)</samp>](https://github.com/soybeanjs/cli/commit/f6ba25b)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**:
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(a89e6)</samp>](https://github.com/soybeanjs/cli/commit/a89e61f)
- **projects**:
  - update scripts update-pkg &nbsp;-&nbsp; by @soybeanjs [<samp>(4f160)</samp>](https://github.com/soybeanjs/cli/commit/4f16042)
  - update launch.json &nbsp;-&nbsp; by @soybeanjs [<samp>(9b656)</samp>](https://github.com/soybeanjs/cli/commit/9b656cf)
...
- **projects**: update launch.json &nbsp;-&nbsp; by @soybeanjs [<samp>(9b656)</samp>](https://github.com/soybeanjs/cli/commit/9b656cf)
...
- **projects**: update scripts update-pkg &nbsp;-&nbsp; by @soybeanjs [<samp>(4f160)</samp>](https://github.com/soybeanjs/cli/commit/4f16042)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(a89e6)</samp>](https://github.com/soybeanjs/cli/commit/a89e61f)
...
- **projects**: use enquirer replace prompts &nbsp;-&nbsp; by @soybeanjs [<samp>(bff7d)</samp>](https://github.com/soybeanjs/cli/commit/bff7dd9)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(60bdb)</samp>](https://github.com/soybeanjs/cli/commit/60bdbb3)
...
- **projects**: add release script to update template version &nbsp;-&nbsp; by @soybeanjs [<samp>(1dcaa)</samp>](https://github.com/soybeanjs/cli/commit/1dcaa70)
...
- **projects**: update cli version of create-soybean template &nbsp;-&nbsp; by @soybeanjs [<samp>(695e8)</samp>](https://github.com/soybeanjs/cli/commit/695e89a)
...
- **projects**: support break change &nbsp;-&nbsp; by @soybeanjs [<samp>(f5261)</samp>](https://github.com/soybeanjs/cli/commit/f526176)

### &nbsp;&nbsp;&nbsp;🔥 Performance

- **projects**: remove minimist &nbsp;-&nbsp; by @soybeanjs [<samp>(831bb)</samp>](https://github.com/soybeanjs/cli/commit/831bb79)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **projects**: update prompt description &nbsp;-&nbsp; by @soybeanjs [<samp>(7b7b7)</samp>](https://github.com/soybeanjs/cli/commit/7b7b76d)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- **projects**: update README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(77e20)</samp>](https://github.com/soybeanjs/cli/commit/77e2005)
...
- **projects**:
  - update config &nbsp;-&nbsp; by @soybeanjs [<samp>(030c9)</samp>](https://github.com/soybeanjs/cli/commit/030c9bd)
  - use prompts replace enquirer &nbsp;-&nbsp; by @soybeanjs [<samp>(09652)</samp>](https://github.com/soybeanjs/cli/commit/0965281)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(c5402)</samp>](https://github.com/soybeanjs/cli/commit/c54027e)
...
- **projects**: fix export &nbsp;-&nbsp; by @soybeanjs [<samp>(d9798)</samp>](https://github.com/soybeanjs/cli/commit/d9798ca)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**:
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(51959)</samp>](https://github.com/soybeanjs/cli/commit/5195924)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(5809b)</samp>](https://github.com/soybeanjs/cli/commit/5809b2e)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(51959)</samp>](https://github.com/soybeanjs/cli/commit/5195924)
...
- **projects**: fix create-soybean bin &nbsp;-&nbsp; by @soybeanjs [<samp>(60b94)</samp>](https://github.com/soybeanjs/cli/commit/60b944d)
...
- **projects**:
  - remove deprecated command &nbsp;-&nbsp; by @soybeanjs [<samp>(7e15f)</samp>](https://github.com/soybeanjs/cli/commit/7e15f0b)
  - add short options &nbsp;-&nbsp; by @soybeanjs [<samp>(14ecd)</samp>](https://github.com/soybeanjs/cli/commit/14ecdb8)
  - add option cleanupDir for cleanup command &nbsp;-&nbsp; by @soybeanjs [<samp>(3ec57)</samp>](https://github.com/soybeanjs/cli/commit/3ec577a)
  - support sun cli in mjs &nbsp;-&nbsp; by @soybeanjs [<samp>(aea2d)</samp>](https://github.com/soybeanjs/cli/commit/aea2d03)
  - add create-soybean template: ts lib by tsup, pnpm monorepo &nbsp;-&nbsp; by @soybeanjs [<samp>(43be0)</samp>](https://github.com/soybeanjs/cli/commit/43be0a9)
  - update tsup template &nbsp;-&nbsp; by @soybeanjs [<samp>(527ea)</samp>](https://github.com/soybeanjs/cli/commit/527ea25)

### &nbsp;&nbsp;&nbsp;🐞 Bug Fixes

- **projects**:
  - fix bin in package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(563ca)</samp>](https://github.com/soybeanjs/cli/commit/563ca9e)
  - fix export files &nbsp;-&nbsp; by @soybeanjs [<samp>(2d30a)</samp>](https://github.com/soybeanjs/cli/commit/2d30a21)
  - fix bumpp &nbsp;-&nbsp; by @soybeanjs [<samp>(f9fa5)</samp>](https://github.com/soybeanjs/cli/commit/f9fa527)

### &nbsp;&nbsp;&nbsp;🔥 Performance

- **projects**: remove useless files & update README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(fe1a2)</samp>](https://github.com/soybeanjs/cli/commit/fe1a26e)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **projects**: use tsup replace unbuild &nbsp;-&nbsp; by @soybeanjs [<samp>(419d6)</samp>](https://github.com/soybeanjs/cli/commit/419d6ed)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- **projects**:
  - fix CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(7049b)</samp>](https://github.com/soybeanjs/cli/commit/7049b55)
  - fix CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(19fb6)</samp>](https://github.com/soybeanjs/cli/commit/19fb644)
  - update create-soybean README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(2df10)</samp>](https://github.com/soybeanjs/cli/commit/2df10f6)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**:
  - update deps: changelog &nbsp;-&nbsp; by @soybeanjs [<samp>(3c9f5)</samp>](https://github.com/soybeanjs/cli/commit/3c9f5a0)
  - update templates pkg versions &nbsp;-&nbsp; by @soybeanjs [<samp>(21a7e)</samp>](https://github.com/soybeanjs/cli/commit/21a7e20)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(cecf7)</samp>](https://github.com/soybeanjs/cli/commit/cecf722)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(32ea7)</samp>](https://github.com/soybeanjs/cli/commit/32ea7e9)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(14ce6)</samp>](https://github.com/soybeanjs/cli/commit/14ce69b)
- **projects**:
  - update vscode launch.json &nbsp;-&nbsp; by @soybeanjs [<samp>(675eb)</samp>](https://github.com/soybeanjs/cli/commit/675eb09)
  - update pnpm version &nbsp;-&nbsp; by @soybeanjs [<samp>(beb09)</samp>](https://github.com/soybeanjs/cli/commit/beb096e)
  - update templates package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(30d06)</samp>](https://github.com/soybeanjs/cli/commit/30d0638)
  - update pnpm version &nbsp;-&nbsp; by @soybeanjs [<samp>(78eb5)</samp>](https://github.com/soybeanjs/cli/commit/78eb50b)

### &nbsp;&nbsp;&nbsp;🎨 Styles

- **projects**:
  - format code &nbsp;-&nbsp; by @soybeanjs [<samp>(51f39)</samp>](https://github.com/soybeanjs/cli/commit/51f39ca)
  - format code &nbsp;-&nbsp; by @soybeanjs [<samp>(7649e)</samp>](https://github.com/soybeanjs/cli/commit/7649e6c)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update release.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(48482)</samp>](https://github.com/soybeanjs/cli/commit/4848264)
...
- **projects**: fix export files &nbsp;-&nbsp; by @soybeanjs [<samp>(2d30a)</samp>](https://github.com/soybeanjs/cli/commit/2d30a21)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(cecf7)</samp>](https://github.com/soybeanjs/cli/commit/cecf722)
- **projects**: update vscode launch.json &nbsp;-&nbsp; by @soybeanjs [<samp>(675eb)</samp>](https://github.com/soybeanjs/cli/commit/675eb09)
...
- **projects**: update create-soybean README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(2df10)</samp>](https://github.com/soybeanjs/cli/commit/2df10f6)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update templates pkg versions &nbsp;-&nbsp; by @soybeanjs [<samp>(21a7e)</samp>](https://github.com/soybeanjs/cli/commit/21a7e20)
...
- **projects**: add create-soybean template: ts lib by tsup, pnpm monorepo &nbsp;-&nbsp; by @soybeanjs [<samp>(43be0)</samp>](https://github.com/soybeanjs/cli/commit/43be0a9)

### &nbsp;&nbsp;&nbsp;🎨 Styles

- **projects**: format code &nbsp;-&nbsp; by @soybeanjs [<samp>(7649e)</samp>](https://github.com/soybeanjs/cli/commit/7649e6c)
...
- **projects**: fix bin in package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(563ca)</samp>](https://github.com/soybeanjs/cli/commit/563ca9e)

### &nbsp;&nbsp;&nbsp;🎨 Styles

- **projects**: format code &nbsp;-&nbsp; by @soybeanjs [<samp>(51f39)</samp>](https://github.com/soybeanjs/cli/commit/51f39ca)
...
- **projects**: fix CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(19fb6)</samp>](https://github.com/soybeanjs/cli/commit/19fb644)
...
- **projects**: fix CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(7049b)</samp>](https://github.com/soybeanjs/cli/commit/7049b55)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps: changelog &nbsp;-&nbsp; by @soybeanjs [<samp>(3c9f5)</samp>](https://github.com/soybeanjs/cli/commit/3c9f5a0)
...
- **projects**: support sun cli in mjs &nbsp;-&nbsp; by @soybeanjs [<samp>(aea2d)</samp>](https://github.com/soybeanjs/cli/commit/aea2d03)
...
- **projects**: remove options of sync-npmmirror &nbsp;-&nbsp; by @soybeanjs [<samp>(0b17b)</samp>](https://github.com/soybeanjs/cli/commit/0b17b90)
...
- **projects**: fix templates vscode settings &nbsp;-&nbsp; by @soybeanjs [<samp>(ea412)</samp>](https://github.com/soybeanjs/cli/commit/ea4122b)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **projects**: remove command sync-npmmirror &nbsp;-&nbsp; by @soybeanjs [<samp>(1c589)</samp>](https://github.com/soybeanjs/cli/commit/1c589b6)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **projects**: update vscode settings &nbsp;-&nbsp; by @soybeanjs [<samp>(edbb7)</samp>](https://github.com/soybeanjs/cli/commit/edbb733)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update release.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(5facb)</samp>](https://github.com/soybeanjs/cli/commit/5facb25)
...
- **projects**: fix release.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(ffdf8)</samp>](https://github.com/soybeanjs/cli/commit/ffdf83b)
...
- **projects**: fix command sync-npmmirror --syncName &nbsp;-&nbsp; by @soybeanjs [<samp>(ec545)</samp>](https://github.com/soybeanjs/cli/commit/ec545f2)
...
- **projects**: update README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(e8dd5)</samp>](https://github.com/soybeanjs/cli/commit/e8dd574)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **projects**:
  - update packageManager &nbsp;-&nbsp; by @soybeanjs [<samp>(ee2de)</samp>](https://github.com/soybeanjs/cli/commit/ee2debd)
  - update deps, config &nbsp;-&nbsp; by @soybeanjs [<samp>(09a7a)</samp>](https://github.com/soybeanjs/cli/commit/09a7a9e)
  - perf template-vue &nbsp;-&nbsp; by @soybeanjs [<samp>(50433)</samp>](https://github.com/soybeanjs/cli/commit/5043307)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update release.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(fec98)</samp>](https://github.com/soybeanjs/cli/commit/fec98a6)
...
- **projects**:
  - sync-npmmirror support multi packages &nbsp;-&nbsp; by @soybeanjs [<samp>(c4899)</samp>](https://github.com/soybeanjs/cli/commit/c489965)
  - add release command wqoptions &nbsp;-&nbsp; by @soybeanjs [<samp>(759c9)</samp>](https://github.com/soybeanjs/cli/commit/759c9d7)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- **projects**: update README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(bf31f)</samp>](https://github.com/soybeanjs/cli/commit/bf31f15)
...
- **projects**: add command: sync-npmmirror &nbsp;-&nbsp; by @soybeanjs [<samp>(2fabc)</samp>](https://github.com/soybeanjs/cli/commit/2fabca6)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **projects**: update create-soybean config, add README.md &nbsp;-&nbsp; by @soybeanjs [<samp>(3dcf2)</samp>](https://github.com/soybeanjs/cli/commit/3dcf2a7)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update relase.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(fa282)</samp>](https://github.com/soybeanjs/cli/commit/fa28282)
...
- **projects**: fix ts template alias &nbsp;-&nbsp; by @soybeanjs [<samp>(e917f)</samp>](https://github.com/soybeanjs/cli/commit/e917fd8)
...
- **projects**: fix create-soybean templates &nbsp;-&nbsp; by @soybeanjs [<samp>(1731d)</samp>](https://github.com/soybeanjs/cli/commit/1731dae)
...
- **projects**: update deps, config, template &nbsp;-&nbsp; by @soybeanjs [<samp>(9df58)</samp>](https://github.com/soybeanjs/cli/commit/9df58e9)
...
- **projects**: update deps and use eslint flat config &nbsp;-&nbsp; by @soybeanjs [<samp>(37658)</samp>](https://github.com/soybeanjs/cli/commit/376583a)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(7cc52)</samp>](https://github.com/soybeanjs/cli/commit/7cc524c)
- **projects**: update config &nbsp;-&nbsp; by @soybeanjs [<samp>(01437)</samp>](https://github.com/soybeanjs/cli/commit/01437f9)
...
- **projects**: fix version &nbsp;-&nbsp; by @soybeanjs [<samp>(88b4b)</samp>](https://github.com/soybeanjs/cli/commit/88b4bcc)

### &nbsp;&nbsp;&nbsp;❤️ Contributors

[![soybeanjs](https://github.com/soybeanjs.png?size=48)](https://github.com/soybeanjs)&nbsp;&nbsp;

## [v0.7.8](https://github.com/soybeanjs/cli/compare/v0.7.7...v0.7.8) (2023-11-15)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(b0d59)</samp>](https://github.com/soybeanjs/cli/commit/b0d5938)
...
- **projects**:
  - fix create-soybean template &nbsp;-&nbsp; by @soybeanjs [<samp>(a8311)</samp>](https://github.com/soybeanjs/cli/commit/a831124)
  - fix create-soybean build export &nbsp;-&nbsp; by @soybeanjs [<samp>(6b005)</samp>](https://github.com/soybeanjs/cli/commit/6b0057f)
  - fix create-soybean build export &nbsp;-&nbsp; by @soybeanjs [<samp>(11e0c)</samp>](https://github.com/soybeanjs/cli/commit/11e0c52)
...
- **projects**: fix create-soybean build export &nbsp;-&nbsp; by @soybeanjs [<samp>(11e0c)</samp>](https://github.com/soybeanjs/cli/commit/11e0c52)
...
- **projects**: fix create-soybean build export &nbsp;-&nbsp; by @soybeanjs [<samp>(6b005)</samp>](https://github.com/soybeanjs/cli/commit/6b0057f)
...
- **projects**: fix create-soybean template &nbsp;-&nbsp; by @soybeanjs [<samp>(a8311)</samp>](https://github.com/soybeanjs/cli/commit/a831124)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(5be7f)</samp>](https://github.com/soybeanjs/cli/commit/5be7f8d)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(c586e)</samp>](https://github.com/soybeanjs/cli/commit/c586e97)
- **projects**: vscode settings &nbsp;-&nbsp; by @soybeanjs [<samp>(9ba38)</samp>](https://github.com/soybeanjs/cli/commit/9ba3829)
...
- **projects**: update template pkg version &nbsp;-&nbsp; by @soybeanjs [<samp>(8a8aa)</samp>](https://github.com/soybeanjs/cli/commit/8a8aa3e)
...
- **projects**: update locale and add command deprecated msg &nbsp;-&nbsp; by @soybeanjs [<samp>(5e03f)</samp>](https://github.com/soybeanjs/cli/commit/5e03f6b)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(ef5d3)</samp>](https://github.com/soybeanjs/cli/commit/ef5d3d4)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update github action release.yml &nbsp;-&nbsp; by @soybeanjs [<samp>(45f7c)</samp>](https://github.com/soybeanjs/cli/commit/45f7cb6)
...
- **projects**: encrypto token &nbsp;-&nbsp; by @soybeanjs [<samp>(824ea)</samp>](https://github.com/soybeanjs/cli/commit/824ea94)
...
- **projects**: fix command action &nbsp;-&nbsp; by @soybeanjs [<samp>(4657f)</samp>](https://github.com/soybeanjs/cli/commit/4657fe1)
...
- **deps**: decrease bumpp version &nbsp;-&nbsp; by @soybeanjs [<samp>(deba6)</samp>](https://github.com/soybeanjs/cli/commit/deba635)
...
- **projects**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(a3de7)</samp>](https://github.com/soybeanjs/cli/commit/a3de746)
...
- **deps**: update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(2b579)</samp>](https://github.com/soybeanjs/cli/commit/2b579a2)
...
- **projects**:
  - update &nbsp;-&nbsp; by @soybeanjs [<samp>(35d9d)</samp>](https://github.com/soybeanjs/cli/commit/35d9d6d)
  - update deps & update config &nbsp;-&nbsp; by @soybeanjs [<samp>(0d001)</samp>](https://github.com/soybeanjs/cli/commit/0d0013f)
...
- **projects**: fix create-soybean build &nbsp;-&nbsp; by @soybeanjs [<samp>(cb942)</samp>](https://github.com/soybeanjs/cli/commit/cb942e8)
...
- **projects**: complete create-soybean &nbsp;-&nbsp; by @soybeanjs [<samp>(dd593)</samp>](https://github.com/soybeanjs/cli/commit/dd5936c)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- **projects**: fix CHANGELOG.md &nbsp;-&nbsp; by @soybeanjs [<samp>(f1c20)</samp>](https://github.com/soybeanjs/cli/commit/f1c20d1)

### &nbsp;&nbsp;&nbsp;❤️ Contributors

[![soybeanjs](https://github.com/soybeanjs.png?size=48)](https://github.com/soybeanjs)&nbsp;&nbsp;

## [v0.6.3](https://github.com/soybeanjs/cli/compare/v0.6.2...v0.6.3) (2023-07-27)

### &nbsp;&nbsp;&nbsp;🐞 Bug Fixes

- **projects**: fix types &nbsp;-&nbsp; by @soybeanjs [<samp>(18d10)</samp>](https://github.com/soybeanjs/cli/commit/18d10fc)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **projects**:
  - add monorepo support & add create-soybean &nbsp;-&nbsp; by **Soybean** [<samp>(b2445)</samp>](https://github.com/soybeanjs/cli/commit/b2445ce)
  - update package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(5127b)</samp>](https://github.com/soybeanjs/cli/commit/5127b18)
  - update deps & update config &nbsp;-&nbsp; by @soybeanjs [<samp>(a4eca)</samp>](https://github.com/soybeanjs/cli/commit/a4ecaff)
...
- **deps**: update @soybeanjs/changelog &nbsp;-&nbsp; by **Soybean** [<samp>(f9194)</samp>](https://github.com/soybeanjs/cli/commit/f919493)
...
[Soybean](mailto:honghuangdc@gmail.com),&nbsp;[刘璐](mailto:hi.alue@qq.com)
...
- **projects**: fix cz-git config, and import commitlint &nbsp;-&nbsp; by **Soybean** [<samp>(41b63)</samp>](https://github.com/soybeanjs/cli/commit/41b63e5)
